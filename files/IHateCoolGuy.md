...
I forgot to write a blog post when i added comments, but ever since i built a comment section the blog code is so much more tangled and long now.

(I was going to add a picture but you can just check the code at the repo [@Github.com](https://github.com/NestOfGhosts/nestofghosts.github.io))